...
class LogicQueue(object):
    ...
    @staticmethod
    def add_queue(episode_id, episode_idx, episode_title, toon_title, toon_nickname):
        try:
            entity = ModelItem.init(episode_id, episode_idx, episode_title, toon_title, toon_nickname)
